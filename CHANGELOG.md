...
## [10.0.0](https://github.com/ArnaudTA/console/compare/v9.10.2...v10.0.0) (2025-12-18)
...
* :art: use upsert zone hook to manage infra repo ([b41cf64](https://github.com/ArnaudTA/console/commit/b41cf64ac2936cddd049b716a9803c0821ef4ca9))
* :art: use upsert zone hook to manage infra repo ([6fe47d1](https://github.com/ArnaudTA/console/commit/6fe47d1922359c4934b5364fa3d87dd86cec129b))
* :children_crossing: rework project selection ([62ee751](https://github.com/ArnaudTA/console/commit/62ee7518e8d44aeaf9268799b1a56ba701120892))
* :construction: zone kv store management ([dc3f639](https://github.com/ArnaudTA/console/commit/dc3f639ff687ab5d974aab4f4d10769043028274))
* :construction: zone kv store management ([628a6e5](https://github.com/ArnaudTA/console/commit/628a6e57cb439c8b899acdb8bf1995eedbe0a184))
* :fire: de-duplicates Argo CD links for default zone ([2db26cd](https://github.com/ArnaudTA/console/commit/2db26cdfce71ffbf330bdbe07a48f1276bad7cd9))
* :fire: remove organization feature ([80dfd78](https://github.com/ArnaudTA/console/commit/80dfd78a539288ae45001d34c15791980bb73326))
* :fire: remove organization feature ([3b331f6](https://github.com/ArnaudTA/console/commit/3b331f680716880e7ae4e33b6e441452e2816f3c))
* :lipstick: add argocd urls for each zone ([2129f9d](https://github.com/ArnaudTA/console/commit/2129f9d57b118d3f7c38e80cc596f895a49f9a83))
* :lipstick: add argocd urls for each zone ([cf467ae](https://github.com/ArnaudTA/console/commit/cf467aeaf82c44099f8b964dd4ef2e00a5323a90))
* :lipstick: adding the project id in namespace labels ([8b4e8d4](https://github.com/ArnaudTA/console/commit/8b4e8d4173570dcd74386e7a524573365ab14504))
* :lipstick: adding the project id in namespace labels ([eace611](https://github.com/ArnaudTA/console/commit/eace611838cd2a5ce0e457971914c9d3bf29e6d0))
* :lipstick: disable cluster selection when creating a zone ([11706ab](https://github.com/ArnaudTA/console/commit/11706abacf78094223b39dfb1e61eab1b2721330))
* :lipstick: disable cluster selection when creating a zone ([a8bb19c](https://github.com/ArnaudTA/console/commit/a8bb19cb4ff50b69b892547e05b1541e322b0ecd))
* :lipstick: user list rework ([5fe7be7](https://github.com/ArnaudTA/console/commit/5fe7be706392a9cb4973576c6fe7b62a0045410e))
* :lipstick: user list rework ([5c13b9d](https://github.com/ArnaudTA/console/commit/5c13b9d756c549a2f12d99e7f7384690f3166553))
* :loud_sound: add logger object ([02c6715](https://github.com/ArnaudTA/console/commit/02c67150d738ae200f8937adb88bf32001ff2b8c))
* :poop: change the naming convention of cluster secret ([a471766](https://github.com/ArnaudTA/console/commit/a47176643cb9a97f41c1345477da60bce5935f85))
* :rocket: empty Vault url to use the default VaultConnection ([e2d3b28](https://github.com/ArnaudTA/console/commit/e2d3b287964952b0f6dd0a00ea97499827cb7198))
* :sparkles: add an 'external' boolean properties on clusters ([4a64abc](https://github.com/ArnaudTA/console/commit/4a64abccea40d2675f435b6cec21bb4f9aa3aa43))
* :sparkles: add environment name tag in helm values ([1668604](https://github.com/ArnaudTA/console/commit/1668604f436f4ae51beb3eef7b018b8f5e42a3f7))
* :sparkles: add npm support in nexus ([024deed](https://github.com/ArnaudTA/console/commit/024deedba03a2602402a0cf175f5c948308a17b7))
* :sparkles: add npm support in npm ([60b7752](https://github.com/ArnaudTA/console/commit/60b7752fd31ca36860e64df9b320d8468163d0d4))
* :sparkles: add project usage on resources tab ([1ee66ce](https://github.com/ArnaudTA/console/commit/1ee66ce8211c2017b328887b7800a2e1ab537300))
* :sparkles: add resources occupancy on clusters ([75ce5e9](https://github.com/ArnaudTA/console/commit/75ce5e9450ca68d45d2635b29e0ff8bd8d8614d7))
* :sparkles: add support for SonarQube and Harbor internal url ([43ce886](https://github.com/ArnaudTA/console/commit/43ce88690883d84214c29a4cb910f81609e8cb4d))
* :sparkles: add tags retention policy rules ([a0e3f98](https://github.com/ArnaudTA/console/commit/a0e3f9839d18c9459264e452b14cc87359a3f6c8))
* :sparkles: Ajout des champs de saisie pour choisir les spécificités du dépôt d'infra ([5d2a156](https://github.com/ArnaudTA/console/commit/5d2a156e691a680995031cac54d558ebc3ee3bff))
* :sparkles: allow cluster name update ([161086d](https://github.com/ArnaudTA/console/commit/161086dfd7c226eac65b3f5e3c835b7f923cf511))
* :sparkles: allow cluster name update ([0cbc53e](https://github.com/ArnaudTA/console/commit/0cbc53eb7f3b0e41f128e1066f584aadb55b9766)), closes [#1582](https://github.com/ArnaudTA/console/issues/1582)
* :sparkles: auto create projectRootDir in Gitlab ([b4f1212](https://github.com/ArnaudTA/console/commit/b4f12120e81d8d689b1d65de12ed06c65a95279b))
* :sparkles: build project kv with config for projects ([f9eb01e](https://github.com/ArnaudTA/console/commit/f9eb01e57e45d90c4390024a0c7a970c34c302e4))
* :sparkles: build project kv with config for projects ([f1c687f](https://github.com/ArnaudTA/console/commit/f1c687f55ee4c8b8c2f342e431fb3f0982ffd72c))
* :sparkles: bulk actions on projects ([0c29a51](https://github.com/ArnaudTA/console/commit/0c29a51e9fcb7fa62314c665721527e9888de9f7))
* :sparkles: bulk actions on projects ([951fc15](https://github.com/ArnaudTA/console/commit/951fc152016e00e3bac6cb1d9920998e3cfb4a80))
* :sparkles: check cluster resources when adding an environment ([826f1e9](https://github.com/ArnaudTA/console/commit/826f1e9d8f46bf2aed419c7c395ef336131849dc))
* :sparkles: config items section ([7c41eea](https://github.com/ArnaudTA/console/commit/7c41eeaec2855355c0fa683d4b7ec81210eae6af))
* :sparkles: create contact email environment variable ([779cb4a](https://github.com/ArnaudTA/console/commit/779cb4a83492d4159a7efa868822adc5640dd6f8))
* :sparkles: display last refresh monitor and display cause to admins ([054ea37](https://github.com/ArnaudTA/console/commit/054ea37d556b1c6e0fabf0e52f4611395aec18b4))
* :sparkles: distinguish between public and internal gitlab url ([616c01c](https://github.com/ArnaudTA/console/commit/616c01c0d1b4607a48a52701a6b101bde8c50f22))
* :sparkles: easy in-cluster config ([eec149f](https://github.com/ArnaudTA/console/commit/eec149f1d4b110297a754b8421c38973ca784a90))
* :sparkles: easy in-cluster config ([01435e2](https://github.com/ArnaudTA/console/commit/01435e2595383b4be00bdafb45970161765da6b9))
* :sparkles: enable pwa on frontend ([9565b1f](https://github.com/ArnaudTA/console/commit/9565b1ff5e409e6c732b9a1a486348da9f45d063))
* :sparkles: enable pwa on frontend ([c6c03f3](https://github.com/ArnaudTA/console/commit/c6c03f3dadf9e954353ad11c29c19d50538d1e2a))
* :sparkles: hooks returned store accept null ([1255a32](https://github.com/ArnaudTA/console/commit/1255a32237a6775e465fc0efe4dfe10bc9463816))
* :sparkles: introduce warn status on project ([9d69357](https://github.com/ArnaudTA/console/commit/9d69357fde2014c1fe134803f8361680bac1d3fc))
* :sparkles: keycloak client management for configuring sso oidc of each argocd zone ([44b3b06](https://github.com/ArnaudTA/console/commit/44b3b06e3882fe2a60691a8bd29572e023b32146))
* :sparkles: nexus customizable write policy ([7f13984](https://github.com/ArnaudTA/console/commit/7f13984efa9d468992245352e9ec46464953555f))
* :sparkles: nexus customizable write policy ([78a004b](https://github.com/ArnaudTA/console/commit/78a004bc72e97b3a98c963560e8c11db45b34b67))
* :sparkles: nexus fine write policy ([14897e6](https://github.com/ArnaudTA/console/commit/14897e685ff6665da35464d93571a972e2c8dae9))
* :sparkles: plugins can return warning to not interupt hook ([3e132c3](https://github.com/ArnaudTA/console/commit/3e132c3238cc98d1d75ec956ce55efebe2c5304a))
* :sparkles: record and display last time a user logged ([1e8323b](https://github.com/ArnaudTA/console/commit/1e8323bbfcd611891fe741434d4cb5f780f45dec))
* :sparkles: return warns and errors message from plugins to user ([be4443f](https://github.com/ArnaudTA/console/commit/be4443fc10db5669578279fbcbac2b4d67adcb52))
* :sparkles: save resources constraints for the project ([58e6d7a](https://github.com/ArnaudTA/console/commit/58e6d7ad2d06fbb9e766fa755ccd7ab44556409e))
* :sparkles: show short logs about project to users ([4888e64](https://github.com/ArnaudTA/console/commit/4888e64527d2627fc2e320300a39745e2571b73c))
* :sparkles: store cluster secret in Vault ([0b1a519](https://github.com/ArnaudTA/console/commit/0b1a519f0340d8f87a8360a08522e9aa3c8ee6fe))
* :sparkles: store cluster secret in Vault ([cea79ef](https://github.com/ArnaudTA/console/commit/cea79efc6ecb4c33d868d7f5044ddc7825c69ed5))
* :sparkles: store cluster secret in Vault ([3935ca6](https://github.com/ArnaudTA/console/commit/3935ca68cb0927bf150e15c3b205baebafa5cb98))
* :sparkles: vault plugin, switch to deploy or not vaultconnections ([0d76c57](https://github.com/ArnaudTA/console/commit/0d76c5787af27d7f641a4b687c14d776842b8009))
* :sparkles: vault plugin, switch to deploy or not vaultconnections ([cc9c4e6](https://github.com/ArnaudTA/console/commit/cc9c4e6ad40412921a8d7afc888f014d92ef46c8))
* :triangular_flag_on_post: remove organizations final part ([73ce9a9](https://github.com/ArnaudTA/console/commit/73ce9a9497f44bb4d831aed8c25f9ee2e8a337f5))
* :zap: limit gitlab api calls to list cicd variables in sonar plugin ([8b04be3](https://github.com/ArnaudTA/console/commit/8b04be3b8dc4627a10bc818d8eb17369d5d31a82))
* :zap: limit gitlab api calls to list cicd variables in sonar plugin ([c1b3299](https://github.com/ArnaudTA/console/commit/c1b32998f4f340c945c657d2dbbb81160fc054f8))
* :zap: optimization of gitlab API calls ([d9b236e](https://github.com/ArnaudTA/console/commit/d9b236ebe032d4976094fed757467165ac40df25))
* ✨ add PAT ([81e3e30](https://github.com/ArnaudTA/console/commit/81e3e307c887f8103a45de4c552222f37e11d5f8))
* ✨ add PAT ([2c35cd7](https://github.com/ArnaudTA/console/commit/2c35cd72a1d0fb14f8c1a633b86e7ef00da80bab))
* ✨ Add the repo UID display on console ([2ed10e4](https://github.com/ArnaudTA/console/commit/2ed10e4b612687b9a18441458749d2821bcff43e))
* ✨ Variabilize clipboard timeout ([2ed10e4](https://github.com/ArnaudTA/console/commit/2ed10e4b612687b9a18441458749d2821bcff43e))
* 🚸 rework project selection ([1641fc9](https://github.com/ArnaudTA/console/commit/1641fc974f455734bedeb0cf2fdaf7356c9b850b))
* add Playwright E2E tests for Keycloak ([1524bba](https://github.com/ArnaudTA/console/commit/1524bba8d6adcc8b360d740e85b51fcf8db71964))
* add README for ArgoCD plugin ([5d66223](https://github.com/ArnaudTA/console/commit/5d66223c5e6af45fdc02d3f1e062a6424b0e6cdc))
* allow cluster informations property to be up to 1000 characters long ([9fe3182](https://github.com/ArnaudTA/console/commit/9fe3182a5c771552f23f1e147475acd606efe67a))
* **client:** add service chain details form ([d56e68c](https://github.com/ArnaudTA/console/commit/d56e68c626ee854fd12e60694acbc87d178ee270))
* configure Playwright Github workflow ([4ac7f55](https://github.com/ArnaudTA/console/commit/4ac7f55f6fc6d3d747bafad20efa7184e608b146))
* gitlab optional internal url ([c1643a1](https://github.com/ArnaudTA/console/commit/c1643a1eaae350220c4ecf114c7fa16bfb1983a1))
* move environments and stages scenario from cypress to playwright ([c4e703f](https://github.com/ArnaudTA/console/commit/c4e703f92f964e5850ca16ae7d066dc6e7d692cf))
* **opencds:** add 'list all service chains' section in admin side menu ([f58de6e](https://github.com/ArnaudTA/console/commit/f58de6e55ad23ed8f8e81aa769f76f9adc62b7b1))
* **opencds:** add client-side service chain details page ([478bc35](https://github.com/ArnaudTA/console/commit/478bc35408c43da95da875b105f1cd8222dfa217))
* **opencds:** add feature toggling default value ([5dc6071](https://github.com/ArnaudTA/console/commit/5dc607178179c5ab76dedf0d84ab22d3e08cabf5))
* **opencds:** add flows retrieval and display as a stepper ([7194218](https://github.com/ArnaudTA/console/commit/71942182464d6c42da0ab818f28ee60024c2e056))
* **opencds:** add mockoon docker image for local dev and ci considerations ([0cf8de5](https://github.com/ArnaudTA/console/commit/0cf8de5cd04860cdcfe2259640abffd48881ac5b))
* **opencds:** adjust service chain list view ([fa0f5c3](https://github.com/ArnaudTA/console/commit/fa0f5c3b91d940547ef132ad443f3b0a187238aa))
* **opencds:** clean up mockoon json ([8bd1f74](https://github.com/ArnaudTA/console/commit/8bd1f7483d5b772705c317510cded0552cad40c6))
* **opencds:** handle OpenCDS API token-based security ([409ae6e](https://github.com/ArnaudTA/console/commit/409ae6e40a2e42b54fd95a05904c35e1efd18371))
* **opencds:** use a badge for state on service-chain list ([e3c1340](https://github.com/ArnaudTA/console/commit/e3c134095e0dc7fb8009bfdb8fc14e6e8d62959b))
* **playwright:** add Project page tests ([419ea3c](https://github.com/ArnaudTA/console/commit/419ea3c735dd3ece8e02ce2d77beaa815170f7cd))
* remove quota table ([1561d8d](https://github.com/ArnaudTA/console/commit/1561d8da82ab1413047a3573269ddc4a133360ca))
* remove Quota table references to use Environment attributes instead ([03297ec](https://github.com/ArnaudTA/console/commit/03297ec88fb69834c6d76f61b25309ce1a363f4f))
* search cluster, table display ([d21be53](https://github.com/ArnaudTA/console/commit/d21be53e168a820f500334d97faa73ae30aeaf6e))
* track project version provisioning ([1f393f1](https://github.com/ArnaudTA/console/commit/1f393f187d305ecb6c8cd6bfb8b9bb33db2414d2))
* track project version provisioning ([227baf6](https://github.com/ArnaudTA/console/commit/227baf6802687c9555d3931071a7e049d2756db1))
* unique dashboard ([d21be53](https://github.com/ArnaudTA/console/commit/d21be53e168a820f500334d97faa73ae30aeaf6e))
* update Cluster model to store resources capability ([6167743](https://github.com/ArnaudTA/console/commit/6167743743c91f5e109da7297de275ea9d4d23d3))
* update Environment form to use new resources attributes ([ff58b26](https://github.com/ArnaudTA/console/commit/ff58b26662db51f385ce49ac14b4073bd5cf71cf))


### Bug Fixes

* :alien: fix nexus monitoring ([8bb7448](https://github.com/ArnaudTA/console/commit/8bb74480deaa2b88628d2a715496e93aa4d27629))
* :alien: gitlab response changed on upgrade ([450ed53](https://github.com/ArnaudTA/console/commit/450ed534ef7a58ef9ba4be459ab522e2aa12c644))
* :alien: gitlab response changed on upgrade ([d595f3a](https://github.com/ArnaudTA/console/commit/d595f3ac80e84070e27ed257d4b8879ee2611d46))
* :ambulance: bad gitlab url fn ([2ec5332](https://github.com/ArnaudTA/console/commit/2ec5332ce320e40da131ff537974c169716e3ac5))
* :ambulance: bad migration ([baa0712](https://github.com/ArnaudTA/console/commit/baa071203693db68154ffda61f99a66a72a2c1c8))
* :ambulance: broken admin token ([6684c91](https://github.com/ArnaudTA/console/commit/6684c914c85f2a1445b9e470acf43b8b83b968a2))
* :ambulance: broken admin token ([a1eff7f](https://github.com/ArnaudTA/console/commit/a1eff7f96c6793338019eea0676b8f6dea4c0056))
* :ambulance: cbx not checked cause vuedsfr breaking change ([b7edb71](https://github.com/ArnaudTA/console/commit/b7edb714f83caf1a33ecc38c42a481d474582dbd))
* :ambulance: cbx not checked cause vuedsfr breaking change ([c7e607f](https://github.com/ArnaudTA/console/commit/c7e607fa6a373866489d7e72e7234107d76a3b7e))
* :ambulance: fix gitlab ci config file ([0a5b0ad](https://github.com/ArnaudTA/console/commit/0a5b0ad219dba8702e2b9239c55b2173b0af925b))
* :ambulance: fix gitlab ci config file ([2c2a287](https://github.com/ArnaudTA/console/commit/2c2a287a76723dfffecd9ae892a8897f03aef161))
* :ambulance: fix not displayed repositories in admin view ([48c0a92](https://github.com/ArnaudTA/console/commit/48c0a92339db999c598fe24cdc9302b28cffa14d))
* :ambulance: fix pat migration ([df3f699](https://github.com/ArnaudTA/console/commit/df3f699ddc972a2b2001a20d5e31dd5ba9ad7482))
* :ambulance: forgot to use slug in gitlab group ([aa22f19](https://github.com/ArnaudTA/console/commit/aa22f1963d0d87d28d1a9d74fbf13ac207545382))
* :ambulance: internal gitlab url ([16f195e](https://github.com/ArnaudTA/console/commit/16f195e55222de023046aaabefa9b6d7f79062ee))
* :ambulance: no check on api response ([88ff82e](https://github.com/ArnaudTA/console/commit/88ff82e31951cbbef3389a2fe865e89cea7e8d8c))
* :ambulance: no check on api response ([cfc56db](https://github.com/ArnaudTA/console/commit/cfc56db5b4cdab03b3515d2cae1477e7546dfef8))
* :ambulance: owner of a project cannot see attached private quota ([8bb2d7d](https://github.com/ArnaudTA/console/commit/8bb2d7d26fcd4b955e0110b88fd52a69e97606bc))
* :ambulance: owner of a project cannot see attached private quota ([297a4ac](https://github.com/ArnaudTA/console/commit/297a4ac410c739142d3ef88f1da58492881ddb6f))
* :bug: adapt status analysis to Nexus 3.78 response ([95001c2](https://github.com/ArnaudTA/console/commit/95001c2d96afa101e9867da177d5eed8dcc6b40d))
* :bug: adapt status analysis to Nexus 3.83.1 response ([4efa720](https://github.com/ArnaudTA/console/commit/4efa720c50e766068d3c8773df83e3754d29c9f1))
* :bug: add a better patch capability for kubernetes ([0050394](https://github.com/ArnaudTA/console/commit/005039450701f9d77a4479487ba872af602ec689))
* :bug: add missing custom source repositories in argocd values (pulling mode) ([5330f7a](https://github.com/ArnaudTA/console/commit/5330f7ae16565d7f6e0840fab7bb86691c6aeb4a))
* :bug: add missing scope when creating keycloak client ([ec24df1](https://github.com/ArnaudTA/console/commit/ec24df116469237ad85e67d183560976283fc1ec))
* :bug: auto re login when session expiry ([6c16e88](https://github.com/ArnaudTA/console/commit/6c16e884d505372a8d2142d5870aed635ac4afbd))
* :bug: can't retrieved enc ns name for gitops cluster ([dcf3c1a](https://github.com/ArnaudTA/console/commit/dcf3c1a147755ae698ba09f7bb7d1d79d13cc1d1))
* :bug: change imports exports to not use z.lazy, fix swagger-ui ([64a60fe](https://github.com/ArnaudTA/console/commit/64a60fe6bc84ea9de51519049252957726963afa))
* :bug: display associated project on cluster form ([488ff24](https://github.com/ArnaudTA/console/commit/488ff24dab0d90a6af83e96bdbe815a0f955220e))
* :bug: downgrade gitlab lib to avoid upsert user warning ([a9f2fcd](https://github.com/ArnaudTA/console/commit/a9f2fcd1795feca7e7ed0593104ca3def89b8159))
* :bug: downgrade gitlab lib to avoid upsert user warning ([90faeff](https://github.com/ArnaudTA/console/commit/90faeff2978e0ee2db7624b895550db278aa9c17))
* :bug: dsfr tabs require rewrite DsoHome.vue ([ea03623](https://github.com/ArnaudTA/console/commit/ea0362303757ac239e5b753af6777514cb714b03))
* :bug: duplicates name should not be already allowed ([64175f1](https://github.com/ArnaudTA/console/commit/64175f153d15f48b7a30243255174e5ecb69f487))
* :bug: duplicates name should not be already allowed ([eb2a4db](https://github.com/ArnaudTA/console/commit/eb2a4db44596ad2f9f6affbbdb2dea84cb28067c))
* :bug: fix behaviour of complex querying on user list ([0b92abb](https://github.com/ArnaudTA/console/commit/0b92abba1d6c0b10436b8d65fa4ee155ad5d677b))
* :bug: fix behaviour of complex querying on user list ([b63bd9a](https://github.com/ArnaudTA/console/commit/b63bd9a56c118fe52ab38589a28c90777c5a557e))
* :bug: fix gitlab deletion API request ([7acd71b](https://github.com/ArnaudTA/console/commit/7acd71bc9aed370882b41f31c37dcbb8122bdd3d))
* :bug: fix not displaying swagger ([e9b6418](https://github.com/ArnaudTA/console/commit/e9b6418680ece3498ce5ca70c875669595ad0a5d))
* :bug: fix not displaying swagger ([6f708a1](https://github.com/ArnaudTA/console/commit/6f708a150402835c4ef044bdb8e69f20dfe3ee32))
* :bug: fix vault detect api hashicorp ([8ca8a05](https://github.com/ArnaudTA/console/commit/8ca8a053c0191c0aa6149c468a2bd34a6846b9da))
* :bug: fix vault detect api hashicorp ([86959f5](https://github.com/ArnaudTA/console/commit/86959f5874f60e898442ba4f734ff1a5581998a6))
* :bug: fix weird front behviours ([8a79d79](https://github.com/ArnaudTA/console/commit/8a79d79107e72917d5bc9e839ed1cf6adc23bdd7))
* :bug: fix weird front behviours ([e06cf11](https://github.com/ArnaudTA/console/commit/e06cf117c0fef4f49749d80a7ac5b8de813c6ed7))
* :bug: gitlab mirror access token generation ([7045582](https://github.com/ArnaudTA/console/commit/70455823614a7684f1e3af7d220c5f99506208d8))
* :bug: improve number inputs for decimal values ([d69a8ba](https://github.com/ArnaudTA/console/commit/d69a8ba547174be521ac8cab0e47db2448415a61))
* :bug: internal url for status monitor ([ba48bd6](https://github.com/ArnaudTA/console/commit/ba48bd6602cbbebf2b41061e748de251686d19d1))
* :bug: minors plugins fix and front ([efc1221](https://github.com/ArnaudTA/console/commit/efc122185256c610a19197758491f6b101a6fd8a))
* :bug: minors plugins fix and front ([22937c8](https://github.com/ArnaudTA/console/commit/22937c875480dc0b6bf67f0784311f98300df04d))
* :bug: missing icons ([d95a11c](https://github.com/ArnaudTA/console/commit/d95a11c1939c1d7dbd18426a56328fb170df3356))
* :bug: missing icons ([d2b98c2](https://github.com/ArnaudTA/console/commit/d2b98c201fb9f4ce3181c2d2b55fdac2a85f11f5))
* :bug: names displayed twice at project creation ([89b82f0](https://github.com/ArnaudTA/console/commit/89b82f09eae3f27378f2636220d10648fe5ba0bd))
* :bug: names displayed twice at project creation ([079a20a](https://github.com/ArnaudTA/console/commit/079a20a4e5d910e64e43a6df2925acee5ea7368c))
* :bug: nexus auto disable repo config on delete ([1295ece](https://github.com/ArnaudTA/console/commit/1295ece0312a6c7b319c379e88be1ee570d75499))
* :bug: only regenerate mirror secret if there is user or token change ([a4a3e0e](https://github.com/ArnaudTA/console/commit/a4a3e0e8b3156d1a3de76d42663d70dcd6ec0a94))
* :bug: public url for Harbor image pull secret ([16cd209](https://github.com/ArnaudTA/console/commit/16cd209a0274d045deeb51f7fabf432448c0066b))
* :bug: retry delete project is failed ([3cef48f](https://github.com/ArnaudTA/console/commit/3cef48f8471d85dd06e93200d8eab05168335ada))
* :bug: retry delete project is failed ([c5856fa](https://github.com/ArnaudTA/console/commit/c5856fadc49acd238ee61d289cf8441a5b3a2e18))
* :bug: set non nullable and default constraints on Repository ([500e497](https://github.com/ArnaudTA/console/commit/500e4978fe8fb7a23976bd8adb39f9650ad4dd32))
* :bug: switch to sequential deletion ([30f7e47](https://github.com/ArnaudTA/console/commit/30f7e478feb4661050222f28e0abd7d32e51c82b))
* :bug: test if description is string before using replaceAll function ([d5b1234](https://github.com/ArnaudTA/console/commit/d5b12342c236dca1231d05528f6ccd7746f62309))
* :bug: update condition to allow private quota modification ([f4c34bb](https://github.com/ArnaudTA/console/commit/f4c34bb1e462a9d393c4af231a0f524eb20fcad1))
* :bug: update depracated import assertion type syntax ([b5aba26](https://github.com/ArnaudTA/console/commit/b5aba2614867e4b2c9568e8db179306ddb580898))
* :bug: update depracated import assertion type syntax ([d8f2072](https://github.com/ArnaudTA/console/commit/d8f20728a0d96c6799e5bba7e821ed12356d6393))
* :bug: update zone values when modifying a cluster ([253acb9](https://github.com/ArnaudTA/console/commit/253acb9d6106727fc11b22c8268cfcd07320001a)), closes [#1642](https://github.com/ArnaudTA/console/issues/1642)
* :bug: upgrade dso-ns chart to fix pull secret path ([13b9648](https://github.com/ArnaudTA/console/commit/13b96488406284c7efd7ca3cfa7ed168ca8b1fa2))
* :bug: use the renamed path of repository/group being deleted ([38b8cff](https://github.com/ArnaudTA/console/commit/38b8cffaff3484257104d325dd9e034bfa2611fa))
* :bug: vault forgot to set kv to v2 ([90dca64](https://github.com/ArnaudTA/console/commit/90dca64aca9d64b8491b332d0151f1be68dcbccc))
* :lipstick: show resources in clusters and environment tables ([8494e2a](https://github.com/ArnaudTA/console/commit/8494e2ad19afc7e0c8afb65ccc2ee216d7399615))
* :loud_sound: change log logic in sonarqube plugin ([726352b](https://github.com/ArnaudTA/console/commit/726352beadba394bc28fd66721a653841e33f6bb))
* :loud_sound: change log logic in sonarqube plugin ([5006562](https://github.com/ArnaudTA/console/commit/500656244f12d0d1edeb995e30be8cfa95ca8a4f))
* :passport_control: allow more actions to admin token ([77d867c](https://github.com/ArnaudTA/console/commit/77d867cb1a283d423c4c9f483a243197c5f29b0a))
* :passport_control: allow more actions to admin token ([81fa606](https://github.com/ArnaudTA/console/commit/81fa60653e2bfbcb37251bda448ea3d2f9805eb3))
* :recycle: add projectId to url params ([3986376](https://github.com/ArnaudTA/console/commit/3986376d418c017f8edc802ad237df4e3a29df25))
* :triangular_flag_on_post: no more cloned repository at gitlab createProject ([211d070](https://github.com/ArnaudTA/console/commit/211d070d77802d894c70c584fa2c41e86a297295))
* :wrench: duplicate changelog entries ([#1587](https://github.com/ArnaudTA/console/issues/1587)) ([ea9fdec](https://github.com/ArnaudTA/console/commit/ea9fdec8e15132d537f888aec0369ccb655a3667))
* :zap: disallow recursive list to avoid big latency ([cb93db2](https://github.com/ArnaudTA/console/commit/cb93db248dc611e5b470878c8eee149a3344af1e))
* :zap: disallow recursive list to avoid big latency ([1fed78c](https://github.com/ArnaudTA/console/commit/1fed78c1742b70918c9bab1ff616f0cf681d66fa))
* :zap: package icons in client ([73fa90d](https://github.com/ArnaudTA/console/commit/73fa90dd8aa0fe9c7fa8075ada31eea39af808e5))
* **#1640:** :bug: only regenerate robot secret if host changes ([e5d3ba8](https://github.com/ArnaudTA/console/commit/e5d3ba87f895451795be1d7fa42a389e63521a68))
* **#1681:** :bug: missing kv creation if not exists ([e862c5c](https://github.com/ArnaudTA/console/commit/e862c5ca51dee5a0216f2c66040f90d510579df4))
* **1638:** add validation for repo names in Zod schema ([48621bd](https://github.com/ArnaudTA/console/commit/48621bdc63446be7cd5e38ca13b98762af322c16))
* allowed sources repositories ([a5ce7ad](https://github.com/ArnaudTA/console/commit/a5ce7ad7a6a3cc17fa8726a6be42cdf53828034b))
* **ci:** remove PNPM_VERSION from Github Actions ([bd1f4af](https://github.com/ArnaudTA/console/commit/bd1f4af2592658f7edcbcada13f1ea6cafcab3d4))
* **client:** ensure branch name is reset to default value after synchronization on a repository ([af0ea44](https://github.com/ArnaudTA/console/commit/af0ea44186dd8c22c370c5c7edd77b4807fb9e80))
* **client:** fix Teams E2E cypress being broken after keycloak realm update ([9c95fdf](https://github.com/ArnaudTA/console/commit/9c95fdffbb208cae9b930fc0d2ca9516bb2cbe9b))
* config and locator due to keycloak upgrade ([516d9d5](https://github.com/ArnaudTA/console/commit/516d9d5bc34b5261490170f2c356c050168f54e5))
* fix admin roles not being retrieved when a new user logs in for the first time ([e40c00b](https://github.com/ArnaudTA/console/commit/e40c00b1b25ecb4026612018737a6a0a1abd5aec))
* fix docker build permissions to allow local path import ([c0aaa2f](https://github.com/ArnaudTA/console/commit/c0aaa2f29017845575c38ef83d18850f6ae741cb))
* fix docker build permissions to allow local path import ([6b9461d](https://github.com/ArnaudTA/console/commit/6b9461dd5e481486a5d1e479f4364348e1cf4fda))
* fix formatting issue ([662a834](https://github.com/ArnaudTA/console/commit/662a8342bd83242a61eceae900eb328b1eab5cc5))
* fix gitlab, no first commit on cloned repository ([31605d0](https://github.com/ArnaudTA/console/commit/31605d09aeb02e7a3a20fee1e7cd73ba8c3bc83e))
* fix gitlab, no first commit on cloned repository ([2d7038f](https://github.com/ArnaudTA/console/commit/2d7038fd1f5aefb67259666086048d11a6d5537f))
* fix hiding tile header for all tiles instead of just the projects ones ([156e75a](https://github.com/ArnaudTA/console/commit/156e75a215bd18a90b9abe6adee5a300ea180bbd))
* fix typo ([c20bd60](https://github.com/ArnaudTA/console/commit/c20bd60e462f59222b1d873d65dcb2ec980b6c33))
* **opencds:** fix validatedBy pseudo-null value conflicting with OpenCDS contract in server ([cde51a2](https://github.com/ArnaudTA/console/commit/cde51a2f08cfd64e57714f6096a6ec2d6bb8962f))
* patch vue-dsfr ([02079aa](https://github.com/ArnaudTA/console/commit/02079aaf569b80f1a6a245504757524826a7ab3c))
* **playwright:** bump playwright to 1.54.2 ([44ea5e3](https://github.com/ArnaudTA/console/commit/44ea5e3f5093a45cf95266c0691dad60ca33de26))
* **playwright:** ensure keycloak tests work for all languages ([44e27a3](https://github.com/ArnaudTA/console/commit/44e27a3a8d666949ad29d26b8cbd77da50b067bb))
* **playwright:** fix flaky test on cluster informations by adding a loader ([ffc7b43](https://github.com/ArnaudTA/console/commit/ffc7b436efa7af16a1a7d166c52d02317c26ab74))
* **playwright:** fix format command not working ([578e4b3](https://github.com/ArnaudTA/console/commit/578e4b3e5a0538ac41e9410d09b47f45b98f30bb))
* release please condition ([c293866](https://github.com/ArnaudTA/console/commit/c29386619ff3624d22a2a72f9753bc443045b5c0))
* rely on packageManager property to retrieve the right version of pnpm ([7b20b83](https://github.com/ArnaudTA/console/commit/7b20b832b6f83d367c33573d87c444a8da315703))
* remove cluster resources to avoid confusion on its usage ([2ecf9d7](https://github.com/ArnaudTA/console/commit/2ecf9d70330581b9cb757fa5822a85c6464e0bec))
* **shared:** explicitely import Zod type ([2a8a4d8](https://github.com/ArnaudTA/console/commit/2a8a4d8074e45742769fb2f451672777c4f4afa5))
* **tests:** ensure Cypress tests are green again ([5b7042b](https://github.com/ArnaudTA/console/commit/5b7042b0be48697ce9dfa4a69377a04ceae8fb5c))
* **tests:** fix admin id in pgsql import data not being consistent with keycloak ([3ee2583](https://github.com/ArnaudTA/console/commit/3ee2583c6f1f7761b5586047b6a93d40c3fb5d58))


### Performance Improvements

* :zap: direct service communication for Gitlab pipelines ([4991451](https://github.com/ArnaudTA/console/commit/4991451f3d0c7dbac32cf5fed1fc880b29a37a1c))
